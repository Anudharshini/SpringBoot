...
public class EmployeeRestController {
	...
	//add mapping for POST /employees - add new emp
	@PostMapping("/employees")
	public Employee addEmployee(@RequestBody Employee theEmployee) {
		
		//set id =0 //save new item - instead of update
		theEmployee.setId(0);
	...
	//add mapping for PUT /employees - update emp
	...
	//add mapping for DELETE /employees - update emp
